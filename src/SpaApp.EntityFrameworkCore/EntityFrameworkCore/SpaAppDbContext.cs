...
public class SpaAppDbContext :
    AbpDbContext<SpaAppDbContext>,
    ...
    IIdentityDbContext
{
    ...
    public SpaAppDbContext(DbContextOptions<SpaAppDbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(SpaAppConsts.DbTablePrefix + "YourEntities", SpaAppConsts.DbSchema);
