...
export class ServiceProxy {
    ...
    captcha(): Observable<void> {
        let url_ = this.baseUrl + "/api/app/captcha";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCaptcha(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCaptcha(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processCaptcha(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    validate(body: CaptchaValidateDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/app/captcha/validate";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCommentGET(response: HttpResponseBase): Observable<PagedResultDto_1OfOfCommentDtoAndContractsAnd_0AndCulture_neutralAndPublicKeyToken_null> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    commentPOST(body: CreateUpdateCommentDto | undefined): Observable<CommentDto> {
        let url_ = this.baseUrl + "/api/app/comment";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCommentPOST(response: HttpResponseBase): Observable<CommentDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    commentGET2(id: string): Observable<CommentDto> {
        let url_ = this.baseUrl + "/api/app/comment/{id}";
        if (id === undefined || id === null)
            throw new globalThis.Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCommentGET2(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCommentGET2(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<CommentDto>;
                }
            } else
    ...
    protected processCommentGET2(response: HttpResponseBase): Observable<CommentDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    commentPUT(id: string, body: CreateUpdateCommentDto | undefined): Observable<CommentDto> {
        let url_ = this.baseUrl + "/api/app/comment/{id}";
        if (id === undefined || id === null)
            throw new globalThis.Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
    ...
    protected processCommentPUT(response: HttpResponseBase): Observable<CommentDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    commentDELETE(id: string): Observable<void> {
        let url_ = this.baseUrl + "/api/app/comment/{id}";
        if (id === undefined || id === null)
            throw new globalThis.Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
     ...
     * @return OK
     */
    byGroup(groupName: string | undefined, providerName: string | undefined, providerKey: string | undefined): Observable<GetPermissionListResultDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processByGroup(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processByGroup(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<GetPermissionListResultDto>;
                }
            } else
    ...
    protected processByGroup(response: HttpResponseBase): Observable<GetPermissionListResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class CaptchaValidateDto implements ICaptchaValidateDto {
    ...
    constructor(data?: ICaptchaValidateDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    static fromJS(data: any): CaptchaValidateDto {
        data = typeof data === 'object' ? data : {};
        let result = new CaptchaValidateDto();
        result.init(data);
        return result;
    }
...
export interface ICaptchaValidateDto {
    captchaId?: string | undefined;
    value?: string | undefined;
}
...
export class CreateUpdateCommentDto implements ICreateUpdateCommentDto {
    ...
    static fromJS(data: any): CreateUpdateCommentDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreateUpdateCommentDto();
        result.init(data);
        return result;
    }
...
export class PagedResultDto_1OfOfCommentDtoAndContractsAnd_0AndCulture_neutralAndPublicKeyToken_null implements IPagedResultDto_1OfOfCommentDtoAndContractsAnd_0AndCulture_neutralAndPublicKeyToken_null {
    items?: CommentDto[] | undefined;
    totalCount?: number;

    constructor(data?: IPagedResultDto_1OfOfCommentDtoAndContractsAnd_0AndCulture_neutralAndPublicKeyToken_null) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    static fromJS(data: any): PagedResultDto_1OfOfCommentDtoAndContractsAnd_0AndCulture_neutralAndPublicKeyToken_null {
        data = typeof data === 'object' ? data : {};
        let result = new PagedResultDto_1OfOfCommentDtoAndContractsAnd_0AndCulture_neutralAndPublicKeyToken_null();
        result.init(data);
        return result;
    }
...
export interface IPagedResultDto_1OfOfCommentDtoAndContractsAnd_0AndCulture_neutralAndPublicKeyToken_null {
    items?: CommentDto[] | undefined;
    totalCount?: number;
}
